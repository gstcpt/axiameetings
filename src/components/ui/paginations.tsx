            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th
                    key={header.id}
                    className="px-6 py-4 text-left text-sm font-black text-neutral-600 uppercase tracking-widest"
                  >
        ...
        <div className="flex items-center justify-between px-2 py-4">
          <div className="text-sm text-neutral-500">
            {t.rich('pagination.showing', {
              ...
              span: (chunks) => <span className="font-medium text-slate-700">{chunks}</span>
            })}
          </div>
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center gap-1">
              <span className="text-sm text-neutral-500">{t('pagination.page')}</span>
